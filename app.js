...
console.log(chalk.blueBright.underline.bold("**".repeat(2), `Welcome to Naimal's CLI Student Management System`, "**".repeat(2)));
...
(function (courses) {
    ...
    courses["cloudNativeComputing"] = "Cloud Native Computing";
    courses["seo"] = "Search Engine Optimizaiton";
...
const tuitionFee = {
    ...
    "Cloud Native Computing": 6000,
    "Search Engine Optimizaiton": 45000,
...
async function enterPaymentAmount() {
    const paymentMethod = await inquirer.prompt({
        name: "amount",
        type: "input",
        message: chalk.greenBright(`Transfer Money (Tuition Fee: ${tuitionFee[answer.course]})`),
        validate: function validateInput(value) {
